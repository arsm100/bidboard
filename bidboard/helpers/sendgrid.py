...
def send_confirm_email(to, bid_id):
    ...
    content = Content(
        "text/html", f"<html><table><tr><td align='center'><img src='https://s3.amazonaws.com/bidboard/11.31851.logo.jpg' height='200px'></td></tr><tr><td>Dear {User.query.get((bid.user_id)).first_name} {User.query.get((bid.user_id)).last_name},<br><br>The bidding has closed and you have been declared the winner! The details of your booking are as follows: <br> <br>Total payment: {bid.amount}<br>Billboard size: {billboard.size} <br>Billboard location: {billboard.location} <br>Booking Date and time: {bid.booking_at_readable}<br> <br>  This is the final confirmation email. We look forward to working with you again!<br> Happy Advertising! <br><br>Kind regards, <br> Bidboard Team </td></tr><tr><td align='center'>This is a no-reply address. If you have any questions, please email us <a href='mail=to:ahmed160ramzi@gmail.com'>here.</a></td></tr></table>"
    )
...
def send_outbid_email(to, bid_id, higher_bid_id):
    ...
    content = Content(
        "text/html", f"<html><table><tr><td align='center'><img src='https://s3.amazonaws.com/bidboard/11.31851.logo.jpg' height='200px'></td></tr><tr><td>Dear {User.query.get((bid.user_id)).first_name} {User.query.get((bid.user_id)).last_name},<br><br>Someone has placed a higher bid on one of your booked billboard. The details of the booking are as follows: <br> <br>Your bid: {bid.amount} MYR<br> Highest Bid: {higher_bid.amount} MYR <br>Billboard size: {billboard.size} <br>Billboard location: {billboard.location} <br>Booking Date and time: {bid.booking_at_readable}<br> <br> You still have a chance to get this booking back by raising your bid before {datetime.datetime.fromtimestamp(bid.booking_at)-datetime.timedelta(weeks=-1)}. <br> Happy Advertising! <br><br>Kind regards, <br> Bidboard Team </td></tr><tr><td align='center'>This is a no-reply address. If you have any questions, please email us <a href='mail=to:ahmed160ramzi@gmail.com'>here.</a></td></tr></table>"
    )
